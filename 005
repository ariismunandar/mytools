...
echo "========================================================="
echo " Author    : AriisMunandar    "
echo " Contact   : 08976918425 "
echo " Github    : https://github.com/ariismunandar "
echo " Instagram : arismunandar_005 "
echo " Youtube   : https://www.youtube.com/c/ArisMunandar005
...
echo "--------------"
echo
echo $bi"ketikan angka untuk memilih pilihan yg ada diatas:"
read -p "--•>" pil

if [ $pil = '1' ]
then
git clone https://github.com/ariismunandar/mbfig
cd mbfig
...
if [ $pil = '2' ]
then
git clone https://github.com/ariismunandar/INFO-BMKG-GEMPA/
cd INFO-BMKG-GEMPA
pip install mechanize
pip install requests
python2 bmkg.py
